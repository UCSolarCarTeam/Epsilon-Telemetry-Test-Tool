...
public:
    ...
    void setMotor0SetCurrent(const float& motor0Current);
    void setMotor0SetVelocity(const float& motor0Velocity);
    ...
    void setMotor1Alive();
    void setMotor1SetCurrent();
    void setMotor1SetVelocity();
    void setMotor1BusCurrent();
    void setMotor1BusVoltage();
    void setMotor1VehicleVelocity();
