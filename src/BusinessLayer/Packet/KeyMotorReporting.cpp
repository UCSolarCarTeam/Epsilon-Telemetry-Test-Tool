...
KeyMotorReporting::KeyMotorReporting(KeyMotorData& keyMotorData,
                                     MotorTab& motor0Tab,
                                     MotorTab& motor1Tab)
...
void KeyMotorReporting::setKeyMotorData()
{
    ...
    keyMotorData_.setMotor0BusCurrent(motor0Tab_.busCurrentKey().value());
    ...
    keyMotorData_.setMotor1BusCurrent(motor1Tab_.busCurrentKey().value());
